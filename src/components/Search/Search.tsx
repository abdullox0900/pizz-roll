...
const Search = () => {
    return (
        <div className='py-[12px] px-[18px]  border-b-[1px] border-[text-slate-400] rounded-b-[20px] mb-[15px]'>
            <div className='relative w-full py-[10px] bg-tg-theme-secondary-bg rounded-[10px] '>

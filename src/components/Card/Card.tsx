                    ...
                    return (
                        <li className='w-[180px]' key={index} >
                            <NavLink to={'/inner'}>
                                ...
                                <h4 className='text-[14px] mb-[3px] tg-theme-text'>{item.name ? item.name : '🔥Пицца из половинок'}</h4>
                                <p className='text-[11px] mb-[10px] tg-theme-text'>{item.description ? item.description : 'Соберите свою пиццу 35 см с двумя разными вкусами'}</p>
                                <div className='text-[16px] font-bold tg-theme-text'>{item.price ? item.price : '550 ₽'}</div>
